...
/* @var $model backend\modules\users\models\DieticianSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="dietician-search">
    ...
    <?php // echo $form->field($model, 'dieticianName') ?>

    <?php // echo $form->field($model, 'email') ?>

    <?php // echo $form->field($model, 'dieticianDesription') ?>
