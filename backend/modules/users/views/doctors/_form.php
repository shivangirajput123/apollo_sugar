...
<div class="form-group col-lg-6 col-sm-12">
	<label class="control-label" for="dietician-username">Doctor Name</label>
   ...
   <?php if ($model->isNewRecord) 
    ...
    <?= $form->field($model, 'mobilenumber')->textInput(['maxlength' => 10]) ?>
	 ...
	 <div class="form-group col-lg-6 col-sm-12">
    <?= $form->field($model, 'doctorDesription')->textarea(['rows' => 6]) ?>
</div>
	 <div class="form-group col-lg-6 col-sm-12">
...
<?php $url = Yii::$app->urlManager->createUrl(['/common/specialties/specialities']) ?>
